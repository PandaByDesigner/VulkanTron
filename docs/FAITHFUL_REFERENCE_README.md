> Archived reference: this is the inherited GLTron Faithful Remaster 0.70.1
> README. Its release evidence and installation instructions describe that
> OpenGL project. For this checkout's current VulkanTron scope and commands,
> read the [project README](../README.md) and [VulkanTron plan](VULKANTRON_PLAN.md).
...
[Faithful Remaster](FAITHFUL_REMASTER.md) records the preservation contract
and earlier milestones. [Stabilization](STABILIZATION.md) and
[baseline notes](BASELINE.md) describe the original checkpoint.
