...
/* SDL2/3 relative motion is translated back to the centered SDL1 callback ABI. */
...
/* SDL2/3 joystick instance IDs use a wide signed type to retain the full
 * SDL3 uint32 range while rejecting the historic negative error sentinel. */
